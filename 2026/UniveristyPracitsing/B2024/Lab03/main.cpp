...
//3. Klasę Histogram uzupełnij o operator()(string name,unsigned row) umożliwiający dostęp (odczyt i zapis) 
//   do dowolnego wiersza w dowolnej Serii (tradycyjnie sięganie poza zakres ma się kończyć wyjątkiem).
//4. Klasę Series uzupełnij o metodę vector<double> get_series_view(function<bool(double)>) przyjmującą
//   jako parametr predykat (czyli obiekt klasy function<bool(double)>) i zwracającą vector elementów, dla
//   których predykat jest prawdziwy. Działanie przetestuj na dwóch warunkach:
//    - elementy serii >10
