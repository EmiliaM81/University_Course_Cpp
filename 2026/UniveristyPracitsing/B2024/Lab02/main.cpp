...
// Zaprogramuj klasę do operowania na histogramach. 

// Histogram będzie zbiorem obiektów klasy Series mających nazwę
// i zawierających dynamicznie alokowaną tablicę wartości double.

// Do pustego histogramu hist dodajemy serię metodą hist.add_series("nazwa"). 

// Z kolei do serii w histogramie
// dodajemy wiersz metodą hist["nazwa"].apppend(3.1415).

//  Wreszcie, wartość konkretnego wiersza możemy zmodyfikować np.
// wywołaniem hist["nazwa"][3]=2.71 i pobrać np. wywołaniem double x=hist["nazwa"][3]. 

// Ponadto dla obiektów Series
