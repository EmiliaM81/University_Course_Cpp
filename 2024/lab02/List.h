 ...
 * 
 * @param[in] list  wskaznik do listy
 * @param[in] c wartosc ktora bedziemy przepisywac do stworzenego 'koralika', przyszlego elementa istniejejujacej listy 
 * @return funkcja typu void, dlatego nic nie zwraca. 
 * 
*/
...
void removeEl(slist*, char);

void removeAllEl(slist*, char);
